...
API_ID = int(environ.get('API_ID', '22940312'))
API_HASH = environ.get('API_HASH', '82fb5cd2de25e4c01021b8bbae9909bb')
BOT_TOKEN = environ.get('BOT_TOKEN', "7996739561:AAGhbJD_OuOEMs2KZYI7iOENUUYDKYHq6cM")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6818594183 6697397532').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 'https://t.me/+7-U-dTBpCLplYmY9'))
